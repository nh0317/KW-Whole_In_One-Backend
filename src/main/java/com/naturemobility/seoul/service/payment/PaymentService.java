...
public interface PaymentService {
    ...
    GetUserInfoInPayment getUserInfo(Long userIdx, Long storeIdx) throws BaseException;

    List<GetRefundsRes> getRefundsList(Long partnerIdx, String status) throws BaseException;
